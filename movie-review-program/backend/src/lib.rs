...
pub fn add_movie_review(
    ...
    msg!("Account size: {} bytes", account_len);
    msg!("Rent required: {} lamports", rent_lamports);

    // STEP 4 - Create the PDA account via CPI
    invoke_signed(
    ...
    // STEP 5 - Deserialize, update and serialize account data
    ...
    msg!("Movie review stored successfully!");
